...
public class RPi2HardwarePwm implements IPwmController {
    ...
    public RPi2HardwarePwm(int pin, int periodMs) throws PwmValueOutOfRange, WholeNumberException {
     ...
     */
    public RPi2HardwarePwm(IGpioController controller, int pin, int periodMs) throws PwmValueOutOfRange,
